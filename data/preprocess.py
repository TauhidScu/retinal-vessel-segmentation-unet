...
class VesselSegmentationDataset(Dataset):
    ...
    def process_images(image, label):
        ...
        #print(f'max value for label: {label_np.max()}')
        #print(f'min value for label: {label_np.min()}')
...
# vessel_dataset = VesselSegmentationDataset(db_name=db_name, root=root)

# # Retrieve and process the first image and label (index 0)
# image, label = vessel_dataset[0]