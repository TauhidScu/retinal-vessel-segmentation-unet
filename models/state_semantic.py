...
# Required blocks for U-net, R2U-net, AttU-net and NestedUnet

class conv_block(nn.Module):
    """Convolution Block with two conv layers, each followed by batch norm and ReLU"""
...
class up_conv(nn.Module):
    """Up Convolution Block for increasing spatial dimensions"""
    def __init__(self, in_ch, out_ch):
...
class conv_block_nested(nn.Module):
    """Nested convolution block for NestedUNet"""
...
class AttU_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=3, output_ch=3):
